...
{
    public partial class frmTipoCertificado : Form
    {
        ...
        private void llenarGrid(int iOp)
        {
            ...
            {
                sSql = "";
                sSql += "select id_tipo_certificado_digital, codigo CODIGO, nombres DSCRIPCION," + Environment.NewLine;
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "insert into cel_tipo_certificado_digital (" + Environment.NewLine;
        ...
        private void actualizarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "update cel_tipo_certificado_digital set" + Environment.NewLine;
                ...
                sSql += "where id_tipo_certificado_digital = " + iIdRegistro;
        ...
        private void frmTipoCertificado_Load(object sender, EventArgs e)
        {
            limpiar(0);
        }
    }
