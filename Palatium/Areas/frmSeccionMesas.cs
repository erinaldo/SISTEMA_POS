...
{
    public partial class frmSeccionMesas : Form
    {
        ...
        public frmSeccionMesas(int iVerificador_P)
        {
            this.iVerificador = iVerificador_P;
            InitializeComponent();
        }
        ...
        private void frmSeccionMesas_Load(object sender, EventArgs e)
        {
        ...
        private void frmSeccionMesas_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            Areas.frmComandasCombinar combinar = new Areas.frmComandasCombinar();
            combinar.ShowDialog();

            if (combinar.DialogResult == DialogResult.OK)
            {
                combinar.Close();
                pnlMesas.Controls.Clear();
                mostrarBotonesMesas();
