...
{
    public partial class frmEgresoProductoTerminado : Form
    {
        ...
        public frmEgresoProductoTerminado()
        {
            InitializeComponent();
        }
        ...
        private void frmEgresoProductoTerminado_Load(object sender, EventArgs e)
        {
        ...
        private void grabarRegistro(int iBandera)
        {
            try
            {
                ...
                if (movimientos.realizarEgreso("EG", Convert.ToInt32(cmbBodega.SelectedValue), sAnio, sMes, "MOV",
                                                ...
                                                dBAyudaIngresoNumeros.txtIdentificacion.Text.Trim(), 0, dgvDetalleVenta, 8002) == true)
                {
                    ok = new VentanasMensajes.frmMensajeNuevoOk();
