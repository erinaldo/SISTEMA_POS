...
{
    public partial class frmIngresoProductoTerminado : Form
    {
        ...
        public frmIngresoProductoTerminado()
        {
            InitializeComponent();
        }
        ...
        private void llenarComboBodega()
        {
            try
            {
                ...
                sSql += "from cv402_bodegas where categoria = 2";
        ...
        private void llenarComboMotivo()
        {
            try
            {
                ...
                sSql += "and codigo in ('04', '11', '13', '15', '27', '29', '34')";
        ...
        private void llenarSentenciaIngresos()
        {
            try
            {
                ...
                sSql += "and cg_tipo_movimiento = " + iCgTipoMovimiento_PT + Environment.NewLine;
        ...
        private void grabarRegistro()
        {
            try
            {
                ...
                if (movimientos.realizarIngreso("IN", Convert.ToInt32(cmbBodega.SelectedValue), sAnio, sMes, "MOV",
                                                ...
                                                txtIva.Text.Trim(), txtDescuento.Text.Trim(), dgvDetalleVenta, iCgTipoMovimiento_PT) == true)
                {
        ...
        private void llenarFilaGrid()
        {
            try
            {
                ...
                if (bRespuesta == true)
                {
                    ...
                    dgvDetalleVenta.CurrentRow.Cells[5].Value = "1";
                    ...
                    if (bRespuesta == true)
                    {
                        ...
                        dgvDetalleVenta.CurrentRow.Cells[9].Value = dbPrecioUnitario.ToString("N2");
        ...
        private void frmIngresoProductoTerminado_Load(object sender, EventArgs e)
        {
            llenarComboOficina();
            llenarComboBodega();
            llenarComboMotivo();
        ...
        private void dgvDetalleVenta_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (dgvDetalleVenta.Columns[e.ColumnIndex].Name == "cantidad")
                {
                    //string sCantidadGrid = dgvDetalleVenta.Rows[e.RowIndex].Cells[5].Value.ToString().Trim();

                    //if ((sCantidadGrid == null) || (sCantidadGrid == ""))
                    //{
                    //    dgvDetalleVenta.Rows[e.RowIndex].Cells[5].Value = "1";
                    //}
                    ...
                    else if (dgvDetalleVenta.Rows[e.RowIndex].Cells[5].Value.ToString().Trim() == "")
                    {
                        dgvDetalleVenta.Rows[e.RowIndex].Cells[5].Value = "1";
                    }
                }
