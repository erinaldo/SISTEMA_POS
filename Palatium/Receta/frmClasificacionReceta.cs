...
{
    public partial class frmClasificacionReceta : Form
    {
        ...
        int iIdPosClasificacion;

        public frmClasificacionReceta()
        {
            InitializeComponent();
        }
        ...
        private void llenarGrid(int iBandera)
        {
            try
            {
                ...
                sSql = "";
                sSql += "select id_pos_clasificacion_receta," + Environment.NewLine;
                sSql += "codigo, descripcion," + Environment.NewLine;
                ...
                sSql += "order by id_pos_clasificacion_receta";
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql = "insert into pos_clasificacion_receta (" + Environment.NewLine;
        ...
        private void actualizarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql = "update pos_clasificacion_receta set" + Environment.NewLine;
                sSql += "descripcion = '" + txtDescripcion.Text.Trim().ToUpper() + "'," + Environment.NewLine;
                sSql += "estado = '" + sEstado + "'" + Environment.NewLine;
                sSql += "where id_pos_clasificacion_receta = " + iIdPosClasificacion + Environment.NewLine;
        ...
        private void eliminarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql = "update pos_clasificacion_receta set" + Environment.NewLine;
                sSql += "codigo = '" + txtCodigo.Text.Trim().ToUpper() + "." + iIdPosClasificacion + "'," + Environment.NewLine;
                sSql += "estado = 'E'," + Environment.NewLine;
                sSql += "fecha_anula = GETDATE()," + Environment.NewLine;
                sSql += "usuario_anula = '" + Program.sDatosMaximo[0] + "'," + Environment.NewLine;
                sSql += "terminal_anula = '" + Program.sDatosMaximo[1] + "'" + Environment.NewLine;
                sSql += "where id_pos_clasificacion_receta = " + iIdPosClasificacion;
        ...
        private void frmClasificacionReceta_Load(object sender, EventArgs e)
        {
            limpiarCampos();
        }
        ...
        private void dgvRegistro_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                grupoDatos.Enabled = true;
                iIdPosClasificacion = Convert.ToInt32(dgvRegistro.CurrentRow.Cells[0].Value.ToString());
