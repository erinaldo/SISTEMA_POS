    ...
    public partial class frmTemperatura : Form
    {
        ...
        private void llenarGrid(int iBandera)
        {
            try
            {
                ...
                sSql = "";
                sSql += "select id_pos_temperatura_de_servicio, codigo, descripcion," + Environment.NewLine;
                ...
                sSql += "order by id_pos_temperatura_de_servicio";
        ...
        private void eliminarRegistro()
        {
            try
            {
                ...
                sSql += "where id_pos_temperatura_de_servicio = " + iIdPostemperatura;
        ...
        private void dgvRegistro_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                grupoDatos.Enabled = true;
                iIdPostemperatura = Convert.ToInt32(dgvRegistro.CurrentRow.Cells[0].Value.ToString());
