...
{
    public partial class frmPorcionReceta : Form
    {
        ...
        private void llenarGrid(int iBandera)
        {
            try
            {
                ...
                sSql = "";
                sSql += "select id_pos_porcion, codigo, descripcion," + Environment.NewLine;
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql = "insert into pos_porcion (" + Environment.NewLine;
        ...
        private void eliminarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql = "update pos_porcion set" + Environment.NewLine;
                sSql += "codigo = '" + txtCodigo.Text.Trim().ToUpper() + "." + iIdPosPorcion + "'," + Environment.NewLine;
                sSql += "estado = 'E'," + Environment.NewLine;
                sSql += "fecha_anula = GETDATE()," + Environment.NewLine;
                sSql += "usuario_anula = '" + Program.sDatosMaximo[0] + "'," + Environment.NewLine;
                sSql += "terminal_anula = '" + Program.sDatosMaximo[1] + "'" + Environment.NewLine;
                sSql += "where id_pos_porcion = " + iIdPosPorcion;
        ...
        private void frmPorcionReceta_Load(object sender, EventArgs e)
        {
            limpiarCampos();
        }
        ...
        private void dgvRegistro_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                grupoDatos.Enabled = true;
                iIdPosPorcion = Convert.ToInt32(dgvRegistro.CurrentRow.Cells[0].Value.ToString());
