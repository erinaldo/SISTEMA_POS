...
{
    public partial class frmReferenciaInsumos : Form
    {
        ...
        private void llenarGrid(int iBandera)
        {
            try
            {
                ...
                sSql += "order by id_bod_referencia";
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql = "insert into bod_referencia (" + Environment.NewLine;
        ...
        private void actualizarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql = "update bod_referencia set" + Environment.NewLine;
                sSql += "descripcion = '" + txtDescripcion.Text.Trim().ToUpper() + "'," + Environment.NewLine;
                sSql += "estado = '" + sEstado + "'" + Environment.NewLine;
                sSql += "where id_bod_referencia = " + iIdRegistro + Environment.NewLine;
        ...
        private void frmReferenciaInsumos_Load(object sender, EventArgs e)
        {
            limpiarCampos();
        }
