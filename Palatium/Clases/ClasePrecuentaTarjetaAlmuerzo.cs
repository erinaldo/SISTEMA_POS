...
{
    public class ClasePrecuentaTarjetaAlmuerzo
    {
        ...
        public string llenarPrecuenta(int iIdPedido_P)
        {
            try
            {
                ...
                sTexto += "TICKET TARJETA DE ALMUERZO".PadLeft(33, ' ') + Environment.NewLine;
                sTexto += "".PadLeft(40, '=') + Environment.NewLine;
                sTexto += ("No. ORDEN: " + dtConsulta.Rows[0]["numero_pedido"].ToString()).PadRight(24, ' ') + "No. CUENTA: " + dtConsulta.Rows[0]["cuenta"].ToString() + Environment.NewLine;
                sTexto += ("Fecha:".PadRight(8, ' ') + Convert.ToDateTime(dtConsulta.Rows[0]["fecha_apertura_orden"].ToString()).ToString("dd-MM-yyy")).PadRight(23, ' ') + " Hora: " + Convert.ToDateTime(dtConsulta.Rows[0]["fecha_apertura_orden"].ToString()).ToString("HH:mm:ss") + Environment.NewLine;
                sTexto += "".PadLeft(40, '=') + Environment.NewLine;
                ...
                sTexto += "".PadLeft(40, '=') + Environment.NewLine;
                sTexto += "TOTAL REPORTADO:" + dbTotal.ToString("N2").PadLeft(24, ' ') + Environment.NewLine + Environment.NewLine + "." + Environment.NewLine;
                return sTexto;
            }
